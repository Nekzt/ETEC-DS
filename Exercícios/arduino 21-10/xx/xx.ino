...
const int red = 9; /* connected to PWM pin 11 */

const int green = 11; /* connected to PWM pin 10 */

const int blue = 10; /* connected to PWM pin 9 */
...
int t = 250; /* "t" (time) 1000 milliseconds, feel free to change it */
